...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePageAustralia(),
    );
  }
}

class MyHomePageAustralia extends StatefulWidget {
  MyHomePageAustralia({Key key}) : super(key: key);

  @override
  _MyHomePageAustraliaState createState() => _MyHomePageAustraliaState();
}

class _MyHomePageAustraliaState extends State<MyHomePageAustralia> {
    ...
    try {
      ...
      switch (index) {
        case 0:
          ...
          break;
        case 1:
          _countryList = await CountryProvider.getcountryByRegionalBloc("Oceania",
...
"The continent of Australia, sometimes known in technical contexts by the names Sahul Australinea, or Meganesia to distinguish it from the country of Australia, consists of the landmasses which sit on Australia's continental plate. The name Sahul takes its name from the Sahul Shelf, which is part of the continental shelf of the Australian continent. The continent includes mainland Australia, Tasmania, and the island of New Guinea, which consists of Papua New Guinea and Western New Guinea (a province of Indonesia). Situated in the geographical region of Oceania, Australia is the smallest of the seven traditional continents.",                            textAlign: TextAlign.justify,
                          ...
                          Text(
"The term Oceania, originally a great division of the world, was replaced by the concept of Australia as a continent in the 1950s.[6] Today, the term Oceania is often used to denote the region encompassing the Australian continent, Zealandia and various islands in the Pacific Ocean that are not included in the seven-continent model.",                            textAlign: TextAlign.justify,
                            style: TextStyle(
                              fontSize: 14.0,
                              color: Colors.white,
                              fontStyle: FontStyle.italic,
