...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePageAmericas(),
    );
  }
}

class MyHomePageAmericas extends StatefulWidget {
  MyHomePageAmericas({Key key}) : super(key: key);

  @override
  _MyHomePageAmericasState createState() => _MyHomePageAmericasState();
}

class _MyHomePageAmericasState extends State<MyHomePageAmericas> {
  ...
  void _searchCountry(int index) async {
    try {
      ...
      /*  case 1:
          ...
          break;*/
        case 1:
          _countryList = await CountryProvider.getCountriesByListOfCodes(["ar","bo","bv","br",
          "cl","co","ec","fk","gf","gy","py","pe","gs","sr","uy","ve"],
              filter: CountryFilter());
          break;
        default:
          break;
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: <Widget>[
                      ...
                      _button("South American Countries","" ,() {
                        _searchCountry(1);
                      }),
                    ],
                  ),
